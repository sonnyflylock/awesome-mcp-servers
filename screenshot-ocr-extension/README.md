...
A Chrome extension that captures screenshots and extracts text using AI-powered OCR. Supports multiple AI providers: Gemini Flash 2.0, Claude, and GPT-5.
...
2. Click the Screenshot OCR icon in your toolbar
...
3. Click the refresh icon on the Screenshot OCR card
4. Test your changes
