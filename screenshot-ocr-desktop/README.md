...
A Windows desktop application for AI-powered OCR text extraction from screenshots. Built with Electron.
...
2. Run the installer (`Screenshot-OCR-Setup-x.x.x.exe`) or use the portable version
3. Launch Screenshot OCR from the Start Menu or desktop shortcut
