...
An MCP (Model Context Protocol) server that provides AI-powered OCR text extraction from images. Supports multiple AI providers: Gemini Flash 2.0, Claude, and GPT-5/GPT-4o.
